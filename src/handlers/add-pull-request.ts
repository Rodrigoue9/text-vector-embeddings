...
export async function addPullRequest(context: Context<"pull_request.opened">) {
	...
	if (!isHumanAuthor) {
		logger.debug(
			"Pull request author is not human; storing PR without embeddings.",
			{
