...
export const STRINGS: Record<string, string> = {
	...
	SIMILAR_ISSUE_TITLE:
		"Description: The Java service layer's performance deteriorates under high load, partly due to the absence of effective caching.",
	ISSUE_URL_TEMPLATE: "https://github.com/ubiquity/test-repo/issues/1",
	CONTRIBUTOR_SUGGESTION_TEXT:
		"The following contributors may be suitable for this task:",
	SIMILAR_COMMENT:
		"One time we we working on a fix where the price label should be the first thing that start command checks for and throws an error for",
};
